...
const userSchema = mongoose.Schema({ //definimos la forma en la que se guarda en la BD
    userName : {
        type: String,
...
export default mongoose.model('user',userSchema) //sirve para interactuar con la base de datos
